...
#control parameters: c (150/30000 == 0.005), M, and o
...
python neat-genreads-master/utilities/vcf_compare_OLD.py -r rDNA_repeat_S288c.fsa -g variants_golden_priors.vcf -w simulation_30000_pipeline.vcf -o simulation_30000 -a 0.002 --vcf-out --incl-fail --no-plot
