...
python neat-genreads-master/utilities/vcf_compare_OLD.py -r rDNA_repeat_S288c.fsa -g variants_golden_priors.vcf -w simulation_60000_pipeline.vcf -o simulation_60000 -a 0.002 --vcf-out --incl-fail --no-plot
